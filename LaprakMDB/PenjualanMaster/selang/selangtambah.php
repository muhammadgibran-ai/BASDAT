...
if (isset($_POST['proses'])) {
    ...
    if ($idSelang === '' || $noSelang === '' || $idPompa === '') {
        $formError = 'Semua field selang wajib diisi.';
        ...
        $insertQuery = "INSERT INTO selang (id_selang, no_selang, id_pompa, created_at) VALUES ('$idSelangEscaped', '$noSelangEscaped', '$idPompaEscaped', NOW())";
        ...
        $formError = 'Gagal menambahkan data selang: ' . mysqli_error($conn);
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Tambah Selang - SPBU Hasanuddin</title>
...
<body>
        ...
        <div id="main-nav" class="collapse navbar-collapse">
            <nav>
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="#form-selang">Form Selang</a></li>
    ...
    <div class="sidebar-navigation hidde-sm hidden-xs">
        <div class="logo">
            <a href="selanglihat.php">Tambah<em>Selang</em></a>
        </div>
        <nav>
            <ul>
                <li><a href="#top"><span class="rect"></span><span class="circle"></span>Hero Form</a></li>
                <li><a href="#form-selang"><span class="rect"></span><span class="circle"></span>Input Selang</a></li>
        ...
        <ul class="social-icons">
            <li><a href="#form-selang"><i class="fa fa-plus"></i></a></li>
        ...
        <div class="Modern-Slider content-section" id="top">
            <div class="item item-1">
                <div class="img-fill form-hero">
                    <div class="info">
                        <div>
                            <span class="hero-kicker">Input Data Selang</span>
                            <h1>Tambah Data Selang<br>Ke db_spbu</h1>
                            <p>Form ini sekarang langsung menyimpan data ke tabel <strong>selang</strong> dengan kolom <strong>id_selang</strong>, <strong>no_selang</strong>, dan <strong>id_pompa</strong>.</p>
                            <div class="white-button button">
                                <a href="#form-selang">Isi Form</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="page-content">
        <section id="form-selang" class="content-section">
            <div class="section-heading">
                ...
                <p>Seluruh input sekarang disesuaikan dari struktur tabel selang.</p>
            </div>
            <div class="section-content">
                <div class="form-shell">
                    <h4>Tambah Data Selang</h4>
                    <p>Masukkan data selang baru untuk ditampilkan di halaman list selang.</p>
                    ...
                    <form action="" method="post">
                        <div class="form-grid">
                            <div>
                                ...
                                <input id="id_selang" name="id_selang" type="text" value="<?php echo htmlspecialchars($idSelang, ENT_QUOTES, 'UTF-8'); ?>" placeholder="Contoh: SLG00000" required>
                            </div>
                            <div>
                                <label for="no_selang">Nomor Selang</label>
                                <input id="no_selang" name="no_selang" type="text" value="<?php echo htmlspecialchars($noSelang, ENT_QUOTES, 'UTF-8'); ?>" placeholder="Contoh: GT-A01" required>
                            </div>
                        ...
                        <div class="form-actions">
                            <button type="submit" name="proses">Simpan Selang</button>
