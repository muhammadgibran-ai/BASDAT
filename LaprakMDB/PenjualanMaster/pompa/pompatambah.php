...
if (isset($_POST['proses'])) {
    ...
    if ($idPompa === '' || $noPompa === '') {
        $formError = 'Semua field pompa wajib diisi.';
    } else {
        $idPompaEscaped = mysqli_real_escape_string($conn, $idPompa);
        $noPompaEscaped = mysqli_real_escape_string($conn, $noPompa);
        $insertQuery = "INSERT INTO pompa (id_pompa, no_pompa, created_at) VALUES ('$idPompaEscaped', '$noPompaEscaped', NOW())";
        ...
        $formError = 'Gagal menambahkan data pompa: ' . mysqli_error($conn);
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Tambah Pompa - SPBU Hasanuddin</title>
...
<body>
        ...
        <div id="main-nav" class="collapse navbar-collapse">
            <nav>
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="#form-pompa">Form Pompa</a></li>
    ...
    <div class="sidebar-navigation hidde-sm hidden-xs">
        <div class="logo">
            <a href="pompalihat.php">Tambah<em>Pompa</em></a>
        </div>
        <nav>
            <ul>
                <li><a href="#top"><span class="rect"></span><span class="circle"></span>Hero Form</a></li>
                <li><a href="#form-pompa"><span class="rect"></span><span class="circle"></span>Input Pompa</a></li>
        ...
        <ul class="social-icons">
            <li><a href="#form-pompa"><i class="fa fa-plus"></i></a></li>
        ...
        <div class="Modern-Slider content-section" id="top">
            <div class="item item-1">
                <div class="img-fill form-hero">
                    <div class="info">
                        <div>
                            <span class="hero-kicker">Input Data Pompa</span>
                            <h1>Tambah Data Pompa<br>Ke db_spbu</h1>
                            <p>Form ini sekarang langsung menyimpan data ke tabel <strong>pompa</strong> dengan kolom <strong>id_pompa</strong> dan <strong>no_pompa</strong>.</p>
                            <div class="white-button button">
                                <a href="#form-pompa">Isi Form</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="page-content">
        <section id="form-pompa" class="content-section">
            <div class="section-heading">
                ...
                <p>Seluruh input disesuaikan dari  struktur tabel pompa.</p>
            </div>
            <div class="section-content">
                <div class="form-shell">
                    <h4>Tambah Data Pompa</h4>
                    <p>Masukkan data pompa baru untuk ditampilkan di halaman list pompa.</p>
                    ...
                    <form action="" method="post">
                        <div class="form-grid">
                            <div>
                                ...
                                <input id="id_pompa" name="id_pompa" type="text" value="<?php echo htmlspecialchars($idPompa, ENT_QUOTES, 'UTF-8'); ?>" placeholder="Contoh: P000001" required>
                            </div>
                            <div>
                                <label for="no_pompa">Nomor Pompa</label>
                                <input id="no_pompa" name="no_pompa" type="text" value="<?php echo htmlspecialchars($noPompa, ENT_QUOTES, 'UTF-8'); ?>" placeholder="Contoh: Pompa 01" required>
                            </div>
                        </div>
                        <div class="form-actions">
                            <button type="submit" name="proses">Simpan Pompa</button>
